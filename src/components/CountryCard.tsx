...
export default function CountryCard({ result }: { result: Country }) {
  ...
  const [openBorders, setOpenBorders] = React.useState<boolean>(false);
            ...
            >
              ...
              >
                ...
                <Collapse in={openCapital} timeout="auto" unmountOnExit>
                  <List component="div" disablePadding>
                    <ListItemButton sx={{ pl: 4 }}>
                      <ListItemText primary={result.name.common} />
                    </ListItemButton>
                  </List>
                </Collapse>
                ...
                <Collapse in={openRegion} timeout="auto" unmountOnExit>
                  <List component="div" disablePadding>
                    <ListItemButton sx={{ pl: 4 }}>
                      <ListItemText primary={result.region} />
                    </ListItemButton>
                  </List>
                </Collapse>
                ...
                <Collapse in={openBorders} timeout="auto" unmountOnExit>
                  <List component="div" disablePadding>
                    ...
                    >
                      <ListItemText
                        primary={
                          result.borders ? result.borders : <>NO BORDERS</>
                        }
                      />
                    </ListItemButton>
                  </List>
                  ...
                  <List component="div" disablePadding>
                    <ListItemButton sx={{ pl: 4 }}>
                      <ListItemText
                        primary={
                          result.currencies &&
                          Object.keys(result.currencies).map((key) => {
                            return (
                              <Typography
                                variant="body2"
